//modificação : novo controller para requisições de medicamentos — profissional item 3.2 do cenário TED
package main.java.br.com.ucsal.controller;

import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import main.java.br.com.ucsal.domain.Requisicao;
import main.java.br.com.ucsal.service.RequisicaoService;
...
public class RequisicaoController {
    ...
    @PostMapping
    public ResponseEntity<Requisicao> criar(@RequestBody @Valid Requisicao requisicao) {
